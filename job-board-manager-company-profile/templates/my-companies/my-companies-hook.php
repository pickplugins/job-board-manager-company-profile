...
if(!function_exists('job_bm_my_companies_title')):
    ...
    function job_bm_my_companies_title(){
        ?>
            <div class="nav-head"><?php echo __('My Companies', 'job-board-manager'); ?></div>
        <?php
                ...
                <div class="job-list">
                    ...
                    if ( $wp_query->have_posts() ) :
                        while ( $wp_query->have_posts() ) : $wp_query->the_post();
                            ...
                            do_action('job_bm_my_companies_loop', $job_id);
...
if(!function_exists('job_bm_my_companies_loop_wrap_start')){
    function job_bm_my_companies_loop_wrap_start($job_id){
...
if(!function_exists('job_bm_my_companies_loop_header')){
    function job_bm_my_companies_loop_header($job_id){
        ...
        <div class="card-top">
            <div class="card-action">
                <span class="job-id" title="<?php echo __('Company id.', 'job-board-manager'); ?>">#<?php echo
                    $job_id; ?></span>
                <a class="job-edit" title="<?php echo __('Company edit.', 'job-board-manager'); ?>" href="<?php echo
                $job_bm_company_edit_page_url; ?>?company_id=<?php echo $job_id; ?>" target="_blank"><i class="fas
                fa-pencil-alt"></i></a>
...
if(!function_exists('job_bm_my_companies_loop_body')){
    function job_bm_my_companies_loop_body($job_id){
